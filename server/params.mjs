...
export const CATALOGUE = [
  ...
  { cle: 'forme.hrv_chute_pct', groupe: 'forme', type: 'nombre', defaut: 10, unite: '%', ordre: 20,
    ...
    aide: { fr: 'Par rapport à la ligne de base — « fatigue accumulée ».', pl: 'Względem linii bazowej — „skumulowane zmęczenie”.' } },
  { cle: 'forme.hrv_base_jours', groupe: 'forme', type: 'nombre', defaut: 30, unite: 'j', ordre: 30,
    libelle: { fr: 'HRV : jours de la ligne de base', pl: 'HRV: dni linii bazowej' },
    aide: { fr: 'La moyenne des HRV du matin sur ces jours, avant la mesure comparée.', pl: 'Średnia porannych HRV z tylu dni przed porównywanym pomiarem.' } },
  { cle: 'forme.base_jours', groupe: 'forme', type: 'nombre', defaut: 42, unite: 'j', ordre: 40,
    libelle: { fr: 'Base endurance : constante de lissage', pl: 'Baza wytrzymałościowa: stała wygładzania' },
    aide: { fr: 'La charge (durée × RPE) lissée sur ce nombre de jours — ce que l’entraînement a construit.', pl: 'Obciążenie (czas × RPE) wygładzone na tylu dniach — to, co zbudował trening.' } },
  { cle: 'forme.fatigue_jours', groupe: 'forme', type: 'nombre', defaut: 7, unite: 'j', ordre: 50,
    libelle: { fr: 'Fatigue : constante de lissage', pl: 'Zmęczenie: stała wygładzania' },
    aide: { fr: 'La même charge, lissée court — ce que les derniers jours ont coûté.', pl: 'To samo obciążenie, wygładzone krótko — koszt ostatnich dni.' } },
  { cle: 'forme.courbe_jours', groupe: 'forme', type: 'nombre', defaut: 84, unite: 'j', ordre: 60,
    libelle: { fr: 'Courbes : fenêtre affichée', pl: 'Wykresy: pokazywane okno' },
    aide: { fr: 'Les jours de base endurance à l’écran ; la HRV en montre la moitié.', pl: 'Dni bazy wytrzymałościowej na ekranie; HRV pokazuje połowę.' } },
  ...
  { cle: 'securite.lien_heures', groupe: 'securite', type: 'nombre', defaut: 48, unite: 'h', ordre: 25, env: 'MSC_LIEN_HEURES',
    libelle: { fr: 'Validité d’un lien de connexion', pl: 'Ważność linku logowania' },
    aide: { fr: 'Le lien à usage unique que l’admin envoie à un athlète. Il vaut une fois, et il périme au bout de ce délai.', pl: 'Jednorazowy link wysyłany przez admina. Działa raz i wygasa po tym czasie.' } },
