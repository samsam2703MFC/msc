...
CREATE TABLE IF NOT EXISTS msc_competition (
  ...
  type_course VARCHAR(24) NULL COMMENT 'le catalogue de src/data/courses.ts : cap_semi, tri_70_3, nat_1500…',
...
CREATE TABLE IF NOT EXISTS msc_analyse (
  ...
  ton         VARCHAR(16) NULL COMMENT 'le coach qui parlait — tortionnaire, gentil, gros_porc',
